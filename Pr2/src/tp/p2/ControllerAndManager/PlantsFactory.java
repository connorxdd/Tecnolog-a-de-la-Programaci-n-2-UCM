...
import tp.p2.Objects.Nuez;
import tp.p2.Objects.Peashooter;
import tp.p2.Objects.PetaCereza;
import tp.p2.Objects.Plant;
import tp.p2.Objects.Sunflower;
...
public abstract class PlantsFactory {
	...
	private static final Plant WallNut = new Nuez(null, 10, "Aguanta golpes", 50, 0, 0, 0, 0);
	...
	public static Plant getPlant(String plantName){
		...
		if(plantName.equals("PEASHOOTER") || plantName.equals("P"))
			...
			resultado = new Nuez(null, 10, "Aguanta golpes", 50, 0, 0, 0, 0);
		return resultado;
	}
